...
As of version **1.6.5**, the module supports two reclaim backends:
...
The module source currently identifies itself as version **1.6.5** and defaults to:
...
- **Version:** `1.6.5`
- **Description:** Auto-backend, idle-aware, join-safe nick reclaim for ZNC (MONITOR when available, otherwise ISON; OnRaw pre-filter, consistent MONITOR subscription guards, hot-reload MONITOR detect, 433/303 swallow, timer cleanup)
